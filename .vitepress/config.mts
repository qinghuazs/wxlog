...
export default withMermaid(defineConfig({
  ...
  rewrites: {
    ...
    '01.AI/04.StableDiffusion/05.部署方案详解.md': 'ai/ai-art-stablediffusion/deployment-guide.md',
    '01.AI/04.StableDiffusion/06.模型下载与配置.md': 'ai/ai-art-stablediffusion/model-guide.md',
    '01.AI/04.StableDiffusion/07.界面功能介绍.md': 'ai/ai-art-stablediffusion/webui-interface.md',
    '01.AI/04.StableDiffusion/08.提示词编写技巧.md': 'ai/ai-art-stablediffusion/prompt-guide.md',
    '01.AI/04.StableDiffusion/09.生成参数详解.md': 'ai/ai-art-stablediffusion/parameters-guide.md',
    '01.AI/04.StableDiffusion/10.模型选择与搭配.md': 'ai/ai-art-stablediffusion/model-selection.md',
    '01.AI/04.StableDiffusion/11.工作流程最佳实践.md': 'ai/ai-art-stablediffusion/workflow-best-practices.md',
    '01.AI/04.StableDiffusion/12.ControlNet入门与应用.md': 'ai/ai-art-stablediffusion/controlnet-guide.md',
    '01.AI/04.StableDiffusion/13.LoRA模型使用.md': 'ai/ai-art-stablediffusion/lora-usage.md',
    '01.AI/04.StableDiffusion/14.图生图工作流.md': 'ai/ai-art-stablediffusion/img2img-workflow.md',
    '01.AI/04.StableDiffusion/15.常用插件推荐.md': 'ai/ai-art-stablediffusion/extensions-guide.md',
    '01.AI/04.StableDiffusion/16.LoRA模型训练.md': 'ai/ai-art-stablediffusion/lora-training.md',
  },
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'StableDiffusion', link: '/ai/ai-art-stablediffusion/roadmap' },
        ]
      },
        ...
        },
        {
        ...
        },
         {
          ...
          items: [
            ...
            { text: '部署方案详解', link: '/ai/ai-art-stablediffusion/deployment-guide' },
            { text: '模型下载与配置', link: '/ai/ai-art-stablediffusion/model-guide' },
            { text: '界面功能介绍', link: '/ai/ai-art-stablediffusion/webui-interface' },
            { text: '提示词编写技巧', link: '/ai/ai-art-stablediffusion/prompt-guide' },
            { text: '生成参数详解', link: '/ai/ai-art-stablediffusion/parameters-guide' },
            { text: '模型选择与搭配', link: '/ai/ai-art-stablediffusion/model-selection' },
            { text: '工作流程最佳实践', link: '/ai/ai-art-stablediffusion/workflow-best-practices' },
            { text: 'ControlNet入门与应用', link: '/ai/ai-art-stablediffusion/controlnet-guide' },
            { text: 'LoRA模型使用', link: '/ai/ai-art-stablediffusion/lora-usage' },
            { text: '图生图工作流', link: '/ai/ai-art-stablediffusion/img2img-workflow' },
            { text: '常用插件推荐', link: '/ai/ai-art-stablediffusion/extensions-guide' },
            { text: 'LoRA模型训练', link: '/ai/ai-art-stablediffusion/lora-training' },
          ]
        },
        {
          text: '提示词',
